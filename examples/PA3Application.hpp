...
private:
   ...
   */
  static std::shared_ptr<VAO> makeParamSurf(DiscreteLinRange rgPhi, DiscreteLinRange rgTheta, const std::function<glm::vec3(float, float)> & posFunc, bool isCyclicInPhi, bool isCyclicInTheta, glm::vec3 color);
   ...
   */
  void makeASphere(unsigned int nbPhi, unsigned int nbTheta, glm::vec3 color);
   ...
   * @see makeASphere()
   */
  void makeATorus(unsigned int nbPhi, unsigned int nbTheta, float smallRadius, glm::vec3 color);
   ...
   * geometric 3d position and the color of the vertices.
   */
  void makeAShell(unsigned int nbPhi, unsigned int nbTheta, glm::vec3 color);
